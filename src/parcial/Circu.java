...
public class Circu extends javax.swing.JFrame {
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(rad, javax.swing.GroupLayout.DEFAULT_SIZE, 78, Short.MAX_VALUE)
                            .addComponent(result)
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            ...
            Circulo calcular = new Circulo(radio.doubleValue());
            resultado = calcular.calculararea();
            result.setText(resultado.toString());
        } catch (Exception errordato) {
            JOptionPane.showMessageDialog(null, "Ingreso de valor no valido "+ errordato.getMessage());
            rad.setText("");
            result.setText("");
        }
